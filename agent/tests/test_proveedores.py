...
class TestProveedores(unittest.TestCase):
    CASOS = {
        "sendgrid_api_key": "SENDGRID_API_KEY=SG." + "a" * 22 + "." + "b" * 43,
        "mailgun_api_key": "MAILGUN_KEY=key-" + "0123456789abcdef" * 2,
        "digitalocean_token": "DO_TOKEN=dop_v1_" + "f" * 64,
        "huggingface_token": "HF_TOKEN=hf_ABcdEFghIJklMNopQRstUVwxYZ012345",
        "azure_storage_key": "AccountName=acme;AccountKey=" + "Z" * 60 + "==;",
