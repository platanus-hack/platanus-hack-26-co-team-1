# team-1 Platanus Hack 26: Bogotá Project
...
- Nicolas Carreño ([@nx01-600](https://github.com/nx01-600))
...
2. Point your local `origin` at **both** repos, so a single `git push` updates each one:
   ...
   git remote set-url --add --push origin https://github.com/platanus-hack/platanus-hack-26-co-team-1.git
